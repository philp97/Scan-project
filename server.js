...
const TELEGRAM_BOT_TOKEN = "7455825859:AAHUKdOYNTVNSwaHIRWJxIMpKgpUSGg97uQ"; // Substitua pelo token do seu bot
const TELEGRAM_CHAT_ID = "7648158287"; // Substitua pelo ID do chat (ou grupo) para onde quer enviar
